...
Object.defineProperty(exports, "TaskDeleteManyPostQueryHook", {
    enumerable: true,
    get: function() {
        return TaskDeleteManyPostQueryHook;
    }
});
...
let TaskDeleteManyPostQueryHook = class TaskDeleteManyPostQueryHook {
    async execute(authContext, _objectName, payload) {
        await this.taskPostQueryHookService.handleTaskTargetsDelete(authContext, payload);
    }
    constructor(taskPostQueryHookService){
        this.taskPostQueryHookService = taskPostQueryHookService;
    }
};
TaskDeleteManyPostQueryHook = _ts_decorate([
...
//# sourceMappingURL=task-delete-many.post-query.hook.js.map