...
Object.defineProperty(exports, "WorkflowModule", {
    enumerable: true,
    get: function() {
...
const _workflowstatusmodule = require("./workflow-status/workflow-status.module");
...
WorkflowModule = _ts_decorate([
    (0, _common.Module)({
        imports: [
            _workflowtriggermodule.WorkflowTriggerModule,
            _workflowstatusmodule.WorkflowStatusModule
        ]
    })
], WorkflowModule);
