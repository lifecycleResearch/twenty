...
Object.defineProperty(exports, "WorkflowRunUpdateManyPreQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowRunUpdateManyPreQueryHook;
    }
});
...
let WorkflowRunUpdateManyPreQueryHook = class WorkflowRunUpdateManyPreQueryHook {
    async execute() {
...
WorkflowRunUpdateManyPreQueryHook = _ts_decorate([
    (0, _workspacequeryhookdecorator.WorkspaceQueryHook)(`workflowRun.updateMany`)
], WorkflowRunUpdateManyPreQueryHook);

//# sourceMappingURL=workflow-run-update-many.pre-query.hook.js.map