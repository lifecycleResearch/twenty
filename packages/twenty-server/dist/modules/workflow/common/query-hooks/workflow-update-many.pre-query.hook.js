...
Object.defineProperty(exports, "WorkflowUpdateManyPreQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowUpdateManyPreQueryHook;
    }
});
...
let WorkflowUpdateManyPreQueryHook = class WorkflowUpdateManyPreQueryHook {
    async execute() {
...
WorkflowUpdateManyPreQueryHook = _ts_decorate([
    (0, _workspacequeryhookdecorator.WorkspaceQueryHook)(`workflow.updateMany`)
], WorkflowUpdateManyPreQueryHook);

//# sourceMappingURL=workflow-update-many.pre-query.hook.js.map