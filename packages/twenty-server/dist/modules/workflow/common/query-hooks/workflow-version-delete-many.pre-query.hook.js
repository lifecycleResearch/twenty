...
Object.defineProperty(exports, "WorkflowVersionDeleteManyPreQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowVersionDeleteManyPreQueryHook;
    }
});
...
let WorkflowVersionDeleteManyPreQueryHook = class WorkflowVersionDeleteManyPreQueryHook {
    async execute() {
...
WorkflowVersionDeleteManyPreQueryHook = _ts_decorate([
    (0, _workspacequeryhookdecorator.WorkspaceQueryHook)(`workflowVersion.deleteMany`)
], WorkflowVersionDeleteManyPreQueryHook);

//# sourceMappingURL=workflow-version-delete-many.pre-query.hook.js.map