...
Object.defineProperty(exports, "WorkflowRunCreateOnePreQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowRunCreateOnePreQueryHook;
    }
});
...
let WorkflowRunCreateOnePreQueryHook = class WorkflowRunCreateOnePreQueryHook {
    async execute() {
...
WorkflowRunCreateOnePreQueryHook = _ts_decorate([
    (0, _workspacequeryhookdecorator.WorkspaceQueryHook)(`workflowRun.createOne`)
], WorkflowRunCreateOnePreQueryHook);

//# sourceMappingURL=workflow-run-create-one.pre-query.hook.js.map