...
Object.defineProperty(exports, "WorkflowRunDeleteManyPreQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowRunDeleteManyPreQueryHook;
    }
});
...
let WorkflowRunDeleteManyPreQueryHook = class WorkflowRunDeleteManyPreQueryHook {
    async execute() {
...
WorkflowRunDeleteManyPreQueryHook = _ts_decorate([
    (0, _workspacequeryhookdecorator.WorkspaceQueryHook)(`workflowRun.deleteMany`)
], WorkflowRunDeleteManyPreQueryHook);

//# sourceMappingURL=workflow-run-delete-many.pre-query.hook.js.map