...
Object.defineProperty(exports, "WorkflowVersionUpdateManyPreQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowVersionUpdateManyPreQueryHook;
    }
});
...
let WorkflowVersionUpdateManyPreQueryHook = class WorkflowVersionUpdateManyPreQueryHook {
    async execute() {
...
WorkflowVersionUpdateManyPreQueryHook = _ts_decorate([
    (0, _workspacequeryhookdecorator.WorkspaceQueryHook)(`workflowVersion.updateMany`)
], WorkflowVersionUpdateManyPreQueryHook);

//# sourceMappingURL=workflow-version-update-many.pre-query.hook.js.map