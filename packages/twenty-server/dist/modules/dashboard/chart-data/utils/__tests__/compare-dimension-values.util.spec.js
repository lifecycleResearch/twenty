...
describe('compareDimensionValues', ()=>{
    describe('string comparison (default)', ()=>{
        it('should compare strings alphabetically in ascending order', ()=>{
            const result = (0, _comparedimensionvaluesutil.compareDimensionValues)({
                rawValueA: 'Alpha',
                rawValueB: 'Beta',
    ...
    describe('numeric comparison', ()=>{
        it('should compare numbers in ascending order', ()=>{
            const result = (0, _comparedimensionvaluesutil.compareDimensionValues)({
                ...
                formattedValueB: '200',
                direction: 'ASC',
                fieldType: _types.FieldMetadataType.NUMBER
            });
            expect(result).toBeLessThan(0);
        });
    ...
    describe('currency comparison', ()=>{
        it('should compare currency amountMicros numerically', ()=>{
            const result = (0, _comparedimensionvaluesutil.compareDimensionValues)({
                ...
                direction: 'ASC',
                fieldType: _types.FieldMetadataType.CURRENCY,
...
//# sourceMappingURL=compare-dimension-values.util.spec.js.map