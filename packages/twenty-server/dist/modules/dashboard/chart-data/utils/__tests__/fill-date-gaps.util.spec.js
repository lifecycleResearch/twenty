...
describe('fillDateGaps', ()=>{
    describe('edge cases', ()=>{
        it('should return empty data unchanged', ()=>{
            const result = (0, _filldategapsutil.fillDateGaps)({
                data: [],
...
describe('fillDateGapsTwoDimensional', ()=>{
    describe('edge cases', ()=>{
        it('should return empty data unchanged', ()=>{
            const result = (0, _filldategapsutil.fillDateGapsTwoDimensional)({
                data: [],
                dateGranularity: _types.ObjectRecordGroupByDateGranularity.DAY
            });
            expect(result.data).toEqual([]);
    ...
    describe('DAY granularity gap filling', ()=>{
        it('should fill missing date-secondary combinations with zero values', ()=>{
            ...
            const day1A = result.data.find((d)=>d.groupByDimensionValues[0] === '2024-01-01' && d.groupByDimensionValues[1] === 'A');
            const day1B = result.data.find((d)=>d.groupByDimensionValues[0] === '2024-01-01' && d.groupByDimensionValues[1] === 'B');
            const day2A = result.data.find((d)=>d.groupByDimensionValues[0] === '2024-01-02' && d.groupByDimensionValues[1] === 'A');
            const day2B = result.data.find((d)=>d.groupByDimensionValues[0] === '2024-01-02' && d.groupByDimensionValues[1] === 'B');
        ...
        it('should handle null secondary dimension values', ()=>{
            ...
            expect(result.data).toHaveLength(3);
            const day2Null = result.data.find((d)=>d.groupByDimensionValues[0] === '2024-01-02' && d.groupByDimensionValues[1] === null);
...
//# sourceMappingURL=fill-date-gaps.util.spec.js.map