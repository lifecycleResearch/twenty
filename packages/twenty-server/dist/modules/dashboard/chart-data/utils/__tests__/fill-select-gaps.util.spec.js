...
describe('fillSelectGaps', ()=>{
    ...
    describe('edge cases', ()=>{
        it('should return data unchanged when selectOptions is undefined', ()=>{
            ...
            const result = (0, _fillselectgapsutil.fillSelectGaps)({
                data,
...
describe('fillSelectGapsTwoDimensional', ()=>{
    ...
    describe('edge cases', ()=>{
        it('should return data unchanged when selectOptions is undefined', ()=>{
            ...
            const result = (0, _fillselectgapsutil.fillSelectGapsTwoDimensional)({
                data,
                selectOptions: undefined
            });
            expect(result).toEqual(data);
    ...
    describe('gap filling', ()=>{
        it('should fill missing primary axis options for all secondary values', ()=>{
            ...
            expect(result.filter((r)=>r.groupByDimensionValues[0] === 'A')).toHaveLength(2);
            expect(result.filter((r)=>r.groupByDimensionValues[0] === 'B')).toHaveLength(2);
            expect(result.filter((r)=>r.groupByDimensionValues[0] === 'C')).toHaveLength(2);
        });
        it('should create zero-value entries for missing combinations', ()=>{
            ...
            expect(result).toHaveLength(6);
            expect(result.find((r)=>r.groupByDimensionValues[0] === 'B' && r.groupByDimensionValues[1] === 'X')).toEqual({
                groupByDimensionValues: [
                    'B',
                    'X'
                ],
            ...
            expect(result.find((r)=>r.groupByDimensionValues[0] === 'A' && r.groupByDimensionValues[1] === 'Y')).toEqual({
                groupByDimensionValues: [
                    'A',
                    'Y'
                ],
        ...
        it('should preserve existing combinations', ()=>{
            ...
            expect(result).toHaveLength(6);
            expect(result.find((r)=>r.groupByDimensionValues[0] === 'A' && r.groupByDimensionValues[1] === 'X')).toEqual({
                groupByDimensionValues: [
                    'A',
                    'X'
                ],
        ...
        it('should handle null secondary dimension values', ()=>{
            ...
            expect(result).toHaveLength(3);
            expect(result.find((r)=>r.groupByDimensionValues[0] === 'B' && r.groupByDimensionValues[1] === null)).toEqual({
                groupByDimensionValues: [
                    'B',
                    null
                ],
...
//# sourceMappingURL=fill-select-gaps.util.spec.js.map