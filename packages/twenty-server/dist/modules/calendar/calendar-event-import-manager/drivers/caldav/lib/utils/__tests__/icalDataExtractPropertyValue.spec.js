...
const _icalDataExtractPropertyValue = require("../icalDataExtractPropertyValue");
describe('icalDataExtractPropertyValue', ()=>{
    describe('properties with parameters (RFC 5545 Section 3.2)', ()=>{
        it('should extract value from property object with val and params', ()=>{
            ...
            const result = (0, _icalDataExtractPropertyValue.icalDataExtractPropertyValue)(property);
        ...
        it('should handle property with empty string val', ()=>{
            ...
            const result = (0, _icalDataExtractPropertyValue.icalDataExtractPropertyValue)(property, 'default');
            expect(result).toBe('');
        });
    });
    describe('multiple values in a single property (RFC 5545 Section 3.1.2)', ()=>{
        ...
        it('should return default value when array contains only empty values', ()=>{
            ...
            const result = (0, _icalDataExtractPropertyValue.icalDataExtractPropertyValue)(property, 'No values');
...
//# sourceMappingURL=icalDataExtractPropertyValue.spec.js.map