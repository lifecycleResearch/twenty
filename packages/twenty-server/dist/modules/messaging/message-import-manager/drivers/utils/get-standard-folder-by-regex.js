...
Object.defineProperty(exports, "getStandardFolderByRegex", {
    enumerable: true,
    get: function() {
        return getStandardFolderByRegex;
    }
});
const _standardfolder = require("../types/standard-folder");
const FOLDER_REGEX_PATTERNS = {
    [_standardfolder.StandardFolder.INBOX]: [
        // EN
        'inbox',
        '^mail$',
        '^messages?$',
    ...
    [_standardfolder.StandardFolder.DRAFTS]: [
        // EN
        'drafts?',
    ...
    [_standardfolder.StandardFolder.SENT]: [
        // EN
    ...
    [_standardfolder.StandardFolder.TRASH]: [
        // EN
        'trash',
    ...
    [_standardfolder.StandardFolder.JUNK]: [
        // EN
        'spam',
...
const CACHED_REGEX_PATTERNS = Object.fromEntries(Object.entries(FOLDER_REGEX_PATTERNS).map(([standardFolder, patterns])=>[
        standardFolder,
        new RegExp(patterns.map((s)=>`(${s})`).join('|'), 'i')
    ]));
function getStandardFolderByRegex(folderName) {
...
//# sourceMappingURL=get-standard-folder-by-regex.js.map