...
describe('buildGmailLabelSearchName', ()=>{
    it('should return null for folder without name', ()=>{
        const result = (0, _buildgmaillabelsearchnameutil.buildGmailLabelSearchName)({
            externalId: 'Label_1',
            name: '',
            parentFolderId: null
        }, []);
    ...
    it('should convert spaces to hyphens and lowercase', ()=>{
        ...
        const result = (0, _buildgmaillabelsearchnameutil.buildGmailLabelSearchName)(folder, [
            folder
        ]);
    ...
    it('should build full path for nested folder', ()=>{
        ...
        const result = (0, _buildgmaillabelsearchnameutil.buildGmailLabelSearchName)(child, allFolders);
    ...
    it('should handle deeply nested folders', ()=>{
        ...
        const result = (0, _buildgmaillabelsearchnameutil.buildGmailLabelSearchName)(child, [
            grandparent,
            parent,
            child
        ]);
...
//# sourceMappingURL=build-gmail-label-search-name.spec.js.map