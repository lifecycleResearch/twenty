...
const _isemailblocklistedutil = require("../is-email-blocklisted.util");
describe('isEmailBlocklisted', ()=>{
    it('should return true if email is blocklisted', ()=>{
        ...
        const result = (0, _isemailblocklistedutil.isEmailBlocklisted)(channelHandles, email, blocklist);
...
//# sourceMappingURL=is-email-blocklisted.util.spec.js.map