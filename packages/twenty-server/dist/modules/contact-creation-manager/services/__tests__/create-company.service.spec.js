...
describe('CreateCompanyService', ()=>{
    ...
    const companyToCreate1withSlash = {
        domainName: 'example1.com/',
        createdBySource: _types.FieldActorSource.MANUAL,
        createdByContext: {
            provider: _types.ConnectedAccountProvider.GOOGLE
    ...
    beforeEach(async ()=>{
        ...
        service = module.get(_createcompanyservice.CreateCompanyService);
    });
    describe('With no existing companies', ()=>{
        ...
        it('should create only one of example.com & example.com/ ', async ()=>{
            await service.createOrRestoreCompanies([
                companyToCreate1,
                companyToCreate1withSlash
            ], workspaceId);
            expect(mockCompanyRepository.find).toHaveBeenCalled();
            expect(mockCompanyRepository.save).toHaveBeenCalledWith(expect.arrayContaining([
...
//# sourceMappingURL=create-company.service.spec.js.map