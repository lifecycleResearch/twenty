...
Object.defineProperty(exports, "computeWebhooks", {
    enumerable: true,
    get: function() {
        return computeWebhooks;
    }
});
const _utils = require("twenty-shared/utils");
const _databaseeventaction = require("../../../api/graphql/graphql-query-runner/enums/database-event-action");
const computeWebhooks = (type, item, _flatObjectMetadataMaps, _flatFieldMetadataMaps)=>{
    const updatedFields = {
        type: 'array',
        items: {
            type: 'string'
                    ...
                    'application/json': {
                        schema: {
                            ...
                            properties: {
                                ...
                                ...type === _databaseeventaction.DatabaseEventAction.UPDATED && {
                                    updatedFields
                                }
                            }
                        }
...
//# sourceMappingURL=computeWebhooks.utils.js.map