...
Object.defineProperty(exports, "EventLogCleanupCronCommand", {
    enumerable: true,
    get: function() {
        return EventLogCleanupCronCommand;
    }
});
...
let EventLogCleanupCronCommand = class EventLogCleanupCronCommand extends _nestcommander.CommandRunner {
    async run() {
        await this.messageQueueService.addCron({
            jobName: _eventlogcleanupcronjob.EventLogCleanupCronJob.name,
            data: undefined,
            options: {
                repeat: {
                    pattern: _eventlogcleanupcronpatternconstant.EVENT_LOG_CLEANUP_CRON_PATTERN
                }
            }
        });
    }
...
EventLogCleanupCronCommand = _ts_decorate([
...
//# sourceMappingURL=event-log-cleanup.cron.command.js.map