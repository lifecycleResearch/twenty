...
Object.defineProperty(exports, "FileWorkflowResolver", {
    enumerable: true,
    get: function() {
        return FileWorkflowResolver;
    }
});
...
let FileWorkflowResolver = class FileWorkflowResolver {
    async uploadWorkflowFile({ id: workspaceId }, { createReadStream, filename }) {
    ...
    constructor(fileWorkflowService){
...
], FileWorkflowResolver.prototype, "uploadWorkflowFile", null);
FileWorkflowResolver = _ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _fileworkflowservice.FileWorkflowService === "undefined" ? Object : _fileworkflowservice.FileWorkflowService
    ])
], FileWorkflowResolver);

//# sourceMappingURL=file-workflow.resolver.js.map