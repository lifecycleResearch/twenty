...
Object.defineProperty(exports, "FileAIChatResolver", {
    enumerable: true,
    get: function() {
        return FileAIChatResolver;
    }
});
...
let FileAIChatResolver = class FileAIChatResolver {
    async uploadAIChatFile({ id: workspaceId }, { createReadStream, filename }) {
    ...
    constructor(fileAIChatService){
        this.fileAIChatService = fileAIChatService;
    }
};
_ts_decorate([
...
], FileAIChatResolver.prototype, "uploadAIChatFile", null);
FileAIChatResolver = _ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _fileaichatservice.FileAIChatService === "undefined" ? Object : _fileaichatservice.FileAIChatService
    ])
], FileAIChatResolver);

//# sourceMappingURL=file-ai-chat.resolver.js.map