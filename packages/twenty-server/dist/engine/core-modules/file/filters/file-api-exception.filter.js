...
Object.defineProperty(exports, "FileApiExceptionFilter", {
    enumerable: true,
    get: function() {
        return FileApiExceptionFilter;
    }
});
...
let FileApiExceptionFilter = class FileApiExceptionFilter {
    catch(exception, host) {
        const ctx = host.switchToHttp();
        const response = ctx.getResponse();
        switch(exception.code){
            case _fileexception.FileExceptionCode.UNAUTHENTICATED:
                return this.httpExceptionHandlerService.handleError(exception, response, 403);
            case _fileexception.FileExceptionCode.FILE_NOT_FOUND:
                return this.httpExceptionHandlerService.handleError(exception, response, 404);
            case _fileexception.FileExceptionCode.INTERNAL_SERVER_ERROR:
            default:
...
FileApiExceptionFilter = _ts_decorate([
    (0, _common.Catch)(_fileexception.FileException),
...
], FileApiExceptionFilter);

//# sourceMappingURL=file-api-exception.filter.js.map