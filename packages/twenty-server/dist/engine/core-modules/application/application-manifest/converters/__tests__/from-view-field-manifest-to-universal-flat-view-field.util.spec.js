...
const _fromviewfieldmanifesttouniversalflatviewfieldutil = require("../from-view-field-manifest-to-universal-flat-view-field.util");
describe('fromViewFieldManifestToUniversalFlatViewField', ()=>{
    ...
    it('should convert a view field manifest with defaults', ()=>{
        const result = (0, _fromviewfieldmanifesttouniversalflatviewfieldutil.fromViewFieldManifestToUniversalFlatViewField)({
            viewFieldManifest: {
    ...
    it('should respect explicit values', ()=>{
        ...
        expect(result.aggregateOperation).toBe(_types.AggregateOperations.COUNT);
        expect(result.viewFieldGroupUniversalIdentifier).toBe('vfg-uuid-1');
    });
});

//# sourceMappingURL=from-view-field-manifest-to-universal-flat-view-field.util.spec.js.map