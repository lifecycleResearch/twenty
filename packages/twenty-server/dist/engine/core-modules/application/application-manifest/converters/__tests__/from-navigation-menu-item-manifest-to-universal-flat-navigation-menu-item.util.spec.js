...
const _fromnavigationmenuitemmanifesttouniversalflatnavigationmenuitemutil = require("../from-navigation-menu-item-manifest-to-universal-flat-navigation-menu-item.util");
...
describe('fromNavigationMenuItemManifestToUniversalFlatNavigationMenuItem', ()=>{
    ...
    it('should convert a minimal navigation menu item manifest', ()=>{
        const result = (0, _fromnavigationmenuitemmanifesttouniversalflatnavigationmenuitemutil.fromNavigationMenuItemManifestToUniversalFlatNavigationMenuItem)({
            navigationMenuItemManifest: {
                universalIdentifier: 'nav-uuid-1',
                type: _navigationmenuitemtypeenum.NavigationMenuItemType.VIEW,
                position: 0
            },
...
//# sourceMappingURL=from-navigation-menu-item-manifest-to-universal-flat-navigation-menu-item.util.spec.js.map