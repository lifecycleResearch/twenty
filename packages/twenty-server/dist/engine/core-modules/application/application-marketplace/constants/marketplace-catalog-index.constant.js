...
Object.defineProperty(exports, "MARKETPLACE_CATALOG_INDEX", {
    enumerable: true,
    get: function() {
        return MARKETPLACE_CATALOG_INDEX;
    }
});
...
const MARKETPLACE_CATALOG_INDEX = [
    {
    ...
    },
    {
        ...
        richDisplayData: {
            ...
            screenshots: [],
            aboutDescription: 'A minimal example app that demonstrates the Twenty app framework. Creates a PostCard object and a logic function to generate new postcards. Great starting point for building your own apps.',
            providers: [],
            objects: [
                {
...
//# sourceMappingURL=marketplace-catalog-index.constant.js.map