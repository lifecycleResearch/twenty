...
const _transformstripesubscriptioneventtodatabasesubscriptionutil = require("../transform-stripe-subscription-event-to-database-subscription.util");
...
describe('transformStripeSubscriptionEventToDatabaseSubscription', ()=>{
                ...
                data: [
                    {
                        ...
                        current_period_start: mockTimestamp - 2592000
                    }
                ]
            },
    ...
    it('should transform basic subscription data correctly', ()=>{
        ...
        const result = (0, _transformstripesubscriptioneventtodatabasesubscriptionutil.transformStripeSubscriptionEventToDatabaseSubscription)(mockWorkspaceId, mockData);
        expect(result).toEqual({
            ...
            metadata: {},
            collectionMethod: _billingsubscriptioncollectionmethodenum.BillingSubscriptionCollectionMethod.CHARGE_AUTOMATICALLY,
    ...
    it('should handle all subscription statuses correctly', ()=>{
        const statuses = [
            ...
            [
                'incomplete_expired',
                _billingsubscriptionstatusenum.SubscriptionStatus.IncompleteExpired
            ],
            [
                'past_due',
    ...
    it('should handle different collection methods', ()=>{
        const methods = [
            [
                ...
                _billingsubscriptioncollectionmethodenum.BillingSubscriptionCollectionMethod.CHARGE_AUTOMATICALLY
            ],
            [
                'send_invoice',
                _billingsubscriptioncollectionmethodenum.BillingSubscriptionCollectionMethod.SEND_INVOICE
            ]
        ];
...
//# sourceMappingURL=transform-stripe-subscription-event-to-database-subscription.util.spec.js.map