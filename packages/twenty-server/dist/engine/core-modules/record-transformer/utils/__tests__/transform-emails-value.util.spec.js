...
const _transformemailsvalueutil = require("../transform-emails-value.util");
describe('transformEmailsValue', ()=>{
    it('should return undefined when value is undefined', ()=>{
        const result = (0, _transformemailsvalueutil.transformEmailsValue)(undefined);
        expect(result).toBeUndefined();
    });
    it('should return null when value is null', ()=>{
        const result = (0, _transformemailsvalueutil.transformEmailsValue)(null);
    ...
    it('should convert primaryEmail to lowercase', ()=>{
        ...
        const result = (0, _transformemailsvalueutil.transformEmailsValue)(value);
    ...
    it('should convert additionalEmails array to lowercase JSON string', ()=>{
        ...
        const result = (0, _transformemailsvalueutil.transformEmailsValue)(value);
        expect(result.additionalEmails).toBe('["user1@example.com","user2@example.com"]');
    });
    ...
    it('should handle mixed case emails in additionalEmails array', ()=>{
        ...
        const result = (0, _transformemailsvalueutil.transformEmailsValue)(value);
        expect(result.additionalEmails).toBe('["test1@example.com","test2@example.com"]');
    });
...
//# sourceMappingURL=transform-emails-value.util.spec.js.map