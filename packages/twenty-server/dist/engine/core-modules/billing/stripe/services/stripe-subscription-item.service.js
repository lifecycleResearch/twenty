...
Object.defineProperty(exports, "StripeSubscriptionItemService", {
    enumerable: true,
    get: function() {
        return StripeSubscriptionItemService;
    }
});
...
let StripeSubscriptionItemService = class StripeSubscriptionItemService {
    async updateSubscriptionItem(stripeItemId, updateData) {
        await this.stripe.subscriptionItems.update(stripeItemId, updateData);
    }
    async createSubscriptionItem(stripeSubscriptionId, stripePriceId, quantity) {
        return this.stripe.subscriptionItems.create({
            subscription: stripeSubscriptionId,
            price: stripePriceId,
            ...(0, _utils.isDefined)(quantity) ? {
                quantity
            } : {}
        });
    }
    async deleteSubscriptionItem(stripeItemId, clearUsage = false) {
    ...
    constructor(twentyConfigService, stripeSDKService){
        ...
        this.logger = new _common.Logger(StripeSubscriptionItemService.name);
...
StripeSubscriptionItemService = _ts_decorate([
...
//# sourceMappingURL=stripe-subscription-item.service.js.map