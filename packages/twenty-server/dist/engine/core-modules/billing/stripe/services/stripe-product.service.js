...
Object.defineProperty(exports, "StripeProductService", {
    enumerable: true,
    get: function() {
...
let StripeProductService = class StripeProductService {
    ...
    constructor(twentyConfigService, stripeSDKService){
        ...
        this.logger = new _common.Logger(StripeProductService.name);
...
StripeProductService = _ts_decorate([
...
//# sourceMappingURL=stripe-product.service.js.map