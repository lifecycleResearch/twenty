...
describe('BillingCreditRolloverService', ()=>{
    ...
    let stripeBillingMeterEventService;
    beforeEach(async ()=>{
        const module = await _testing.Test.createTestingModule({
            providers: [
                ...
                {
                    provide: _stripebillingmetereventservice.StripeBillingMeterEventService,
                    useValue: {
        ...
        stripeBillingMeterEventService = module.get(_stripebillingmetereventservice.StripeBillingMeterEventService);
    });
    describe('processRolloverOnPeriodTransition', ()=>{
        ...
        it('should cap rollover at tier quantity when all credits unused', async ()=>{
            ...
            await service.processRolloverOnPeriodTransition(baseParams);
            expect(stripeCreditGrantService.createCreditGrant).toHaveBeenCalledWith(expect.objectContaining({
                creditUnits: 1000
            }));
        });
        ...
        it('should void existing rollover grants before creating new one', async ()=>{
            ...
            stripeCreditGrantService.listCreditGrants.mockResolvedValue(existingGrants);
            ...
            expect(stripeCreditGrantService.voidCreditGrant).toHaveBeenCalledWith('grant_old');
