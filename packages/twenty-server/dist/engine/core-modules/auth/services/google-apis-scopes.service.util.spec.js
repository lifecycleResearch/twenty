...
describe('GoogleAPIScopesService', ()=>{
    describe('includesExpectedScopes', ()=>{
        ...
        it('should work with the current Google API scopes when draft email is disabled', ()=>{
            ...
            const expectedScopes = (0, _getgoogleapisoauthscopes.getGoogleApisOauthScopes)(false);
        ...
        it('should work with the current Google API scopes when draft email is enabled', ()=>{
            ...
            const expectedScopes = (0, _getgoogleapisoauthscopes.getGoogleApisOauthScopes)(true);
            const result = (0, _googleapisscopesserviceutil.includesExpectedScopes)(actualGoogleScopes, expectedScopes);
            expect(result).toBe(true);
        });
    });
...
//# sourceMappingURL=google-apis-scopes.service.util.spec.js.map