...
let WorkspaceFlatViewFilterMapCacheService = class WorkspaceFlatViewFilterMapCacheService extends _workspacecacheproviderservice.WorkspaceCacheProvider {
    async computeForCache(workspaceId) {
        const [viewFilters, applications, fieldMetadatas, viewFilterGroups, views] = await Promise.all([
    ...
    constructor(viewFilterRepository, applicationRepository, fieldMetadataRepository, viewFilterGroupRepository, viewRepository){
        super(), this.viewFilterRepository = viewFilterRepository, this.applicationRepository = applicationRepository, this.fieldMetadataRepository = fieldMetadataRepository, this.viewFilterGroupRepository = viewFilterGroupRepository, this.viewRepository = viewRepository;
    }
};
WorkspaceFlatViewFilterMapCacheService = _ts_decorate([
    ...
    _ts_param(3, (0, _typeorm.InjectRepository)(_viewfiltergroupentity.ViewFilterGroupEntity)),
