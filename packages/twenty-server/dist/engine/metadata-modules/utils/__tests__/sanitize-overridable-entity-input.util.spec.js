...
const _sanitizeoverridableentityinpututil = require("../sanitize-overridable-entity-input.util");
    ...
    describe('when shouldOverride is false', ()=>{
        it('should pass through properties unchanged and preserve existing overrides', ()=>{
            const existingOverrides = {
                title: 'Previous Override'
            };
            const result = (0, _sanitizeoverridableentityinpututil.sanitizeOverridableEntityInput)({
...
//# sourceMappingURL=sanitize-overridable-entity-input.util.spec.js.map