...
Object.defineProperty(exports, "CreateViewFieldPermissionGuard", {
    enumerable: true,
    get: function() {
        return CreateViewFieldPermissionGuard;
    }
});
...
let CreateViewFieldPermissionGuard = class CreateViewFieldPermissionGuard {
    async canActivate(context) {
        ...
        if (!viewId && Array.isArray(args?.inputs) && args.inputs.length > 0) {
            viewId = typeof args.inputs[0]?.viewId === 'string' ? args.inputs[0].viewId : null;
        }
...
CreateViewFieldPermissionGuard = _ts_decorate([
...
//# sourceMappingURL=create-view-field-permission.guard.js.map