...
Object.defineProperty(exports, "DestroyViewGroupPermissionGuard", {
    enumerable: true,
    get: function() {
        return DestroyViewGroupPermissionGuard;
    }
});
...
let DestroyViewGroupPermissionGuard = class DestroyViewGroupPermissionGuard {
    async canActivate(context) {
        ...
        const viewId = entityId ? await this.viewEntityLookupService.findViewIdByEntityIdAndKind('viewGroup', entityId, request.workspace.id) : null;
...
DestroyViewGroupPermissionGuard = _ts_decorate([
...
//# sourceMappingURL=destroy-view-group-permission.guard.js.map