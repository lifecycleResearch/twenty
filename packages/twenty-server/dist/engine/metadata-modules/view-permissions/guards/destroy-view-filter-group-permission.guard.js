...
Object.defineProperty(exports, "DestroyViewFilterGroupPermissionGuard", {
    enumerable: true,
    get: function() {
        return DestroyViewFilterGroupPermissionGuard;
    }
});
...
let DestroyViewFilterGroupPermissionGuard = class DestroyViewFilterGroupPermissionGuard {
    async canActivate(context) {
        ...
        const viewId = entityId ? await this.viewEntityLookupService.findViewIdByEntityIdAndKind('viewFilterGroup', entityId, request.workspace.id) : null;
...
DestroyViewFilterGroupPermissionGuard = _ts_decorate([
...
//# sourceMappingURL=destroy-view-filter-group-permission.guard.js.map