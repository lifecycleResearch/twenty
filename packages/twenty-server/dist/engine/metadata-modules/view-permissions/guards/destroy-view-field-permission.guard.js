...
Object.defineProperty(exports, "DestroyViewFieldPermissionGuard", {
    enumerable: true,
    get: function() {
        return DestroyViewFieldPermissionGuard;
    }
});
...
let DestroyViewFieldPermissionGuard = class DestroyViewFieldPermissionGuard {
    async canActivate(context) {
        ...
        const viewId = entityId ? await this.viewEntityLookupService.findViewIdByEntityIdAndKind('viewField', entityId, request.workspace.id) : null;
...
DestroyViewFieldPermissionGuard = _ts_decorate([
...
//# sourceMappingURL=destroy-view-field-permission.guard.js.map