...
let WorkspaceFlatViewSortMapCacheService = class WorkspaceFlatViewSortMapCacheService extends _workspacecacheproviderservice.WorkspaceCacheProvider {
    async computeForCache(workspaceId) {
        const [existingViewSorts, applications, views, fieldMetadatas] = await Promise.all([
    ...
    constructor(viewSortRepository, viewRepository, applicationRepository, fieldMetadataRepository){
        super(), this.viewSortRepository = viewSortRepository, this.viewRepository = viewRepository, this.applicationRepository = applicationRepository, this.fieldMetadataRepository = fieldMetadataRepository;
    }
};
WorkspaceFlatViewSortMapCacheService = _ts_decorate([
    ...
    _ts_param(1, (0, _typeorm.InjectRepository)(_viewentity.ViewEntity)),
