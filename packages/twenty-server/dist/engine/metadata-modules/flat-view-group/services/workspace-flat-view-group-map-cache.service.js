...
let WorkspaceFlatViewGroupMapCacheService = class WorkspaceFlatViewGroupMapCacheService extends _workspacecacheproviderservice.WorkspaceCacheProvider {
    ...
    constructor(viewGroupRepository, applicationRepository, viewRepository){
        super(), this.viewGroupRepository = viewGroupRepository, this.applicationRepository = applicationRepository, this.viewRepository = viewRepository;
    }
};
