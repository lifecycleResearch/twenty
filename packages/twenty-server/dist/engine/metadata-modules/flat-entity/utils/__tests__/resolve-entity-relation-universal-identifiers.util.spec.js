...
const _resolveentityrelationuniversalidentifiersutil = require("../resolve-entity-relation-universal-identifiers.util");
const buildFlatEntityMaps = (entries)=>({
...
describe('resolveEntityRelationUniversalIdentifiers', ()=>{
    describe('non-nullable relations', ()=>{
        it('should resolve universal identifier for a provided foreign key', ()=>{
            const result = (0, _resolveentityrelationuniversalidentifiersutil.resolveEntityRelationUniversalIdentifiers)({
                ...
                flatEntityMaps: {
                    flatFieldMetadataMaps: buildFlatEntityMaps([
                        {
                            id: 'field-id-1',
                            universalIdentifier: 'field-ui-1'
                        }
                    ]),
                    flatViewMaps: buildFlatEntityMaps([
                        {
                            id: 'view-id-1',
                            universalIdentifier: 'view-ui-1'
                        }
                    ])
                }
            });
        ...
        it('should throw when a non-nullable foreign key id does not exist in maps', ()=>{
            expect(()=>(0, _resolveentityrelationuniversalidentifiersutil.resolveEntityRelationUniversalIdentifiers)({
                    metadataName: 'viewField',
                    foreignKeyValues: {
                ...
                code: _flatentitymapsexception.FlatEntityMapsExceptionCode.RELATION_UNIVERSAL_IDENTIFIER_NOT_FOUND
            }));
        });
    });
...
//# sourceMappingURL=resolve-entity-relation-universal-identifiers.util.spec.js.map