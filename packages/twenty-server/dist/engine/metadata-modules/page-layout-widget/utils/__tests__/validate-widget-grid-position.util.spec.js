...
const _validatewidgetgridpositionutil = require("../validate-widget-grid-position.util");
describe('validateWidgetGridPosition', ()=>{
    ...
    describe('Valid grid positions', ()=>{
        it('should return empty array for valid grid position', ()=>{
            const errors = (0, _validatewidgetgridpositionutil.validateWidgetGridPosition)(validGridPosition, 'Test Widget');
            expect(errors).toEqual([]);
        });
        it('should return empty array for widget at max column boundary', ()=>{
            const errors = (0, _validatewidgetgridpositionutil.validateWidgetGridPosition)({
                row: 0,
...
//# sourceMappingURL=validate-widget-grid-position.util.spec.js.map