...
Object.defineProperty(exports, "PET_FLAT_FIELDS_MOCK", {
    enumerable: true,
    get: function() {
        return PET_FLAT_FIELDS_MOCK;
    }
});
...
const PET_FLAT_FIELDS_MOCK = {
    noteTargets: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    createdBy: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    timelineActivities: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    attachments: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    taskTargets: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    searchVector: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    species: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    traits: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    comments: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    age: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    location: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    vetPhone: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    vetEmail: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    birthday: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    isGoodWithKids: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    pictures: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    averageCostOfKibblePerMonth: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    makesOwnerThinkOf: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    soundSwag: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    bio: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    interestingFacts: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    extraData: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
...
//# sourceMappingURL=pet-flat-fields.mock.js.map