...
Object.defineProperty(exports, "TIMELINEACTIVITY_FLAT_FIELDS_MOCK", {
    enumerable: true,
    get: function() {
        return TIMELINEACTIVITY_FLAT_FIELDS_MOCK;
    }
});
...
const TIMELINEACTIVITY_FLAT_FIELDS_MOCK = {
    happensAt: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    properties: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    linkedRecordCachedName: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    linkedRecordId: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    linkedObjectMetadataId: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    workspaceMember: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    person: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    opportunity: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    note: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    task: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    workflow: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    workflowVersion: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    workflowRun: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    rocket: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    pet: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    surveyResult: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
...
//# sourceMappingURL=timelineactivity-flat-fields.mock.js.map