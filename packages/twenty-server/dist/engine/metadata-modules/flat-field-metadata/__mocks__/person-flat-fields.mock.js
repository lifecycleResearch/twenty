...
Object.defineProperty(exports, "PERSON_FLAT_FIELDS_MOCK", {
    enumerable: true,
    get: function() {
        return PERSON_FLAT_FIELDS_MOCK;
    }
});
...
const PERSON_FLAT_FIELDS_MOCK = {
    ...
    emails: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    linkedinLink: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    xLink: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    jobTitle: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    phones: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    city: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    avatarUrl: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    company: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    pointOfContactForOpportunities: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    messageParticipants: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    calendarEventParticipants: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    intro: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    whatsapp: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    workPreference: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    performanceRating: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
...
//# sourceMappingURL=person-flat-fields.mock.js.map