...
Object.defineProperty(exports, "COMPANY_FLAT_FIELDS_MOCK", {
    enumerable: true,
    get: function() {
        return COMPANY_FLAT_FIELDS_MOCK;
    }
});
...
const COMPANY_FLAT_FIELDS_MOCK = {
    ...
    domainName: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    employees: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    annualRecurringRevenue: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    address: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    idealCustomerProfile: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    people: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    accountOwner: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    opportunities: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    tagline: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    introVideo: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    workPolicy: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    visaSponsorship: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
...
//# sourceMappingURL=company-flat-fields.mock.js.map