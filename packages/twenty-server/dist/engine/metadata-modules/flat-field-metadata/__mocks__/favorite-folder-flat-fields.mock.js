...
Object.defineProperty(exports, "FAVORITE_FOLDER_FLAT_FIELDS_MOCK", {
    enumerable: true,
    get: function() {
        return FAVORITE_FOLDER_FLAT_FIELDS_MOCK;
    }
});
const _types = require("twenty-shared/types");
const _relationtypeinterface = require("../../field-metadata/interfaces/relation-type.interface");
const _getflatfieldmetadatamock = require("./get-flat-field-metadata.mock");
const FAVORITE_FOLDER_FLAT_FIELDS_MOCK = {
    position: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    name: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    id: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    createdAt: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    updatedAt: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    deletedAt: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
    ...
    favorites: (0, _getflatfieldmetadatamock.getFlatFieldMetadataMock)({
...
//# sourceMappingURL=favorite-folder-flat-fields.mock.js.map