...
let WorkspaceFlatPermissionFlagMapCacheService = class WorkspaceFlatPermissionFlagMapCacheService extends _workspacecacheproviderservice.WorkspaceCacheProvider {
    async computeForCache(workspaceId) {
        ...
        for (const permissionFlagEntity of permissionFlags){
            const flatPermissionFlag = (0, _frompermissionflagentitytoflatpermissionflagutil.fromPermissionFlagEntityToFlatPermissionFlag)({
    ...
    constructor(permissionFlagRepository, applicationRepository, roleRepository){
        super(), this.permissionFlagRepository = permissionFlagRepository, this.applicationRepository = applicationRepository, this.roleRepository = roleRepository;
    }
};
