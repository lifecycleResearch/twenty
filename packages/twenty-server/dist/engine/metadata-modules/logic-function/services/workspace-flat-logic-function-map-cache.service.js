...
let WorkspaceFlatLogicFunctionMapCacheService = class WorkspaceFlatLogicFunctionMapCacheService extends _workspacecacheproviderservice.WorkspaceCacheProvider {
    ...
    constructor(logicFunctionRepository, applicationRepository){
        super(), this.logicFunctionRepository = logicFunctionRepository, this.applicationRepository = applicationRepository;
    }
};
