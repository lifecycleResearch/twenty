...
const _workspacerepository = require("../workspace.repository");
describe('WorkspaceRepository', ()=>{
    let repository;
    let mockEntityManager;
    let mockInternalContext;
    let mockFeatureFlagMap;
    let mockObjectRecordsPermissions;
    let mockQueryRunner;
    beforeEach(()=>{
        mockEntityManager = {
            find: jest.fn(),
        ...
        mockFeatureFlagMap = Object.values(_types.FeatureFlagKey).reduce((acc, key)=>({
                ...acc,
                [key]: false
            }), {});
        ...
        mockQueryRunner = {};
        repository = new _workspacerepository.WorkspaceRepository('test-entity', mockEntityManager, mockFeatureFlagMap, mockQueryRunner, mockObjectRecordsPermissions, false);
        // Mock the private methods
        jest.spyOn(repository, 'getObjectMetadataFromTarget').mockResolvedValue({
            id: 'test-metadata-id',
    ...
    describe('Find Methods', ()=>{
        it('should delegate to workspaceEntityManager find', async ()=>{
            ...
            expect(mockEntityManager.find).toHaveBeenCalledWith('test-entity', {
                where: {
                    id: 'test-id'
                }
            }, {
        ...
        it('should delegate to workspaceEntityManager findBy', async ()=>{
            ...
            expect(mockEntityManager.findBy).toHaveBeenCalledWith('test-entity', {
                id: 'test-id'
            }, {
                shouldBypassPermissionChecks: false,
                objectRecordsPermissions: mockObjectRecordsPermissions
        ...
        it('should delegate to workspaceEntityManager findAndCount', async ()=>{
            ...
            expect(mockEntityManager.findAndCount).toHaveBeenCalledWith('test-entity', {
                where: {
                    id: 'test-id'
                }
            }, {
        ...
        it('should delegate to workspaceEntityManager findOne', async ()=>{
            ...
            expect(mockEntityManager.findOne).toHaveBeenCalledWith('test-entity', {
                where: {
                    id: 'test-id'
                }
            }, {
    ...
    describe('Save Methods', ()=>{
        it('should delegate to workspaceEntityManager save', async ()=>{
            ...
            expect(mockEntityManager.save).toHaveBeenCalledWith('test-entity', {
                id: 'test-id'
            }, undefined, {
                shouldBypassPermissionChecks: false,
                objectRecordsPermissions: mockObjectRecordsPermissions
    ...
    describe('Remove Methods', ()=>{
        it('should delegate to workspaceEntityManager remove', async ()=>{
            ...
            expect(mockEntityManager.remove).toHaveBeenCalledWith('test-entity', {
                id: 'test-id'
            }, undefined, {
                shouldBypassPermissionChecks: false,
                objectRecordsPermissions: mockObjectRecordsPermissions
        ...
        it('should delegate to workspaceEntityManager delete', async ()=>{
            ...
            expect(mockEntityManager.delete).toHaveBeenCalledWith('test-entity', {
                id: 'test-id'
            }, {
                shouldBypassPermissionChecks: false,
                objectRecordsPermissions: mockObjectRecordsPermissions
    ...
    describe('Insert Methods', ()=>{
        it('should delegate to workspaceEntityManager insert', async ()=>{
            ...
            expect(mockEntityManager.insert).toHaveBeenCalledWith('test-entity', {
                id: 'test-id'
            }, undefined, {
                shouldBypassPermissionChecks: false,
                objectRecordsPermissions: mockObjectRecordsPermissions
        ...
        it('should delegate to workspaceEntityManager upsert', async ()=>{
            ...
            expect(mockEntityManager.upsert).toHaveBeenCalledWith('test-entity', {
                id: 'test-id'
            }, [
                'id'
            ], {
    ...
    describe('Update Methods', ()=>{
        it('should delegate to workspaceEntityManager update', async ()=>{
            ...
            expect(mockEntityManager.update).toHaveBeenCalledWith('test-entity', {
                id: 'test-id'
            }, {
                name: 'test'
            }, {
    ...
    describe('Math Methods', ()=>{
        it('should delegate to workspaceEntityManager sum', async ()=>{
            ...
            expect(mockEntityManager.sum).toHaveBeenCalledWith('test-entity', 'testColumn', {
                id: 'test-id'
            }, {
                shouldBypassPermissionChecks: false,
                objectRecordsPermissions: mockObjectRecordsPermissions
        ...
        it('should delegate to workspaceEntityManager increment', async ()=>{
            ...
            expect(mockEntityManager.increment).toHaveBeenCalledWith('test-entity', {
                id: 'test-id'
            }, 'testColumn', 1, {
                shouldBypassPermissionChecks: false,
                objectRecordsPermissions: mockObjectRecordsPermissions
    ...
    describe('Preload and Clear Methods', ()=>{
        it('should delegate to workspaceEntityManager preload', async ()=>{
            ...
            mockEntityManager.preload.mockResolvedValue({
                id: 'test-id'
            });
            await repository.preload(entityLike);
            expect(mockEntityManager.preload).toHaveBeenCalledWith('test-entity', {
                id: 'test-id'
            }, {
                shouldBypassPermissionChecks: false,
                objectRecordsPermissions: mockObjectRecordsPermissions
    ...
    describe('Restricted Methods', ()=>{
        ...
        it('should throw error for findByIds', async ()=>{
            await expect(repository.findByIds()).rejects.toThrow('findByIds is deprecated. Please use findBy with In operator instead.');
        });
        it('should throw error for findOneById', async ()=>{
            await expect(repository.findOneById()).rejects.toThrow('findOneById is deprecated. Please use findOneBy with id condition instead.');
        });
        it('should throw error for exist', async ()=>{
            await expect(repository.exist()).rejects.toThrow('exist is deprecated. Please use exists method instead.');
        });
    });
});

//# sourceMappingURL=workspace.repository.spec.js.map