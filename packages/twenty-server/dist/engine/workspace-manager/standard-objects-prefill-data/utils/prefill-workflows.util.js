...
_export(exports, {
    get CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_AUTOMATED_TRIGGER_ID () {
        return CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_AUTOMATED_TRIGGER_ID;
    },
    get CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_WORKFLOW_ID () {
        return CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_WORKFLOW_ID;
    },
    get CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_WORKFLOW_VERSION_ID () {
        return CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_WORKFLOW_VERSION_ID;
    },
    get QUICK_LEAD_WORKFLOW_ID () {
        return QUICK_LEAD_WORKFLOW_ID;
    },
    get QUICK_LEAD_WORKFLOW_VERSION_ID () {
        return QUICK_LEAD_WORKFLOW_VERSION_ID;
    },
    get prefillWorkflows () {
        return prefillWorkflows;
    }
});
...
const _generatefakeobjectrecordevent = require("../../../../modules/workflow/workflow-builder/workflow-schema/utils/generate-fake-object-record-event");
const _generateobjectrecordfields = require("../../../../modules/workflow/workflow-builder/workflow-schema/utils/generate-object-record-fields");
const _prefillworkflowcodesteplogicfunctionsutil = require("./prefill-workflow-code-step-logic-functions.util");
...
const CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_WORKFLOW_ID = '887c6c06-fbc5-4b45-8d6b-f7b6b0f40b12';
const CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_WORKFLOW_VERSION_ID = '0f276d7e-a950-41ab-ad98-35e80753dc58';
const CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_AUTOMATED_TRIGGER_ID = 'c54f5990-13a3-4c3b-b75d-df09e7843036';
const prefillWorkflows = async (entityManager, workspaceId, schemaName, flatObjectMetadataMaps, flatFieldMetadataMaps)=>{
    const { extractDomainLogicFunctionId, findMatchingCompanyByDomainLogicFunctionId, isPersonalEmailLogicFunctionId } = (0, _prefillworkflowcodesteplogicfunctionsutil.getCreateCompanyWhenAddingNewPersonCodeStepLogicFunctionIds)(workspaceId);
    ...
    if (!(0, _utils.isDefined)(companyObjectMetadataId) || !(0, _utils.isDefined)(personObjectMetadataId)) {
        throw new Error('Company or person object metadata not found');
    }
    const companyObjectMetadata = (0, _findflatentitybyidinflatentitymapsutil.findFlatEntityByIdInFlatEntityMaps)({
        flatEntityId: companyObjectMetadataId,
        flatEntityMaps: flatObjectMetadataMaps
    });
    const personObjectMetadata = (0, _findflatentitybyidinflatentitymapsutil.findFlatEntityByIdInFlatEntityMaps)({
        flatEntityId: personObjectMetadataId,
        flatEntityMaps: flatObjectMetadataMaps
    });
    if (!(0, _utils.isDefined)(companyObjectMetadata) || !(0, _utils.isDefined)(personObjectMetadata)) {
        throw new Error('Company or person object metadata not found');
    }
    const companyDomainNameFieldMetadata = Object.values(flatFieldMetadataMaps.byUniversalIdentifier).find((fieldMetadata)=>fieldMetadata?.objectMetadataId === companyObjectMetadataId && fieldMetadata?.name === 'domainName');
    if (!(0, _utils.isDefined)(companyDomainNameFieldMetadata)) {
        throw new Error('Company domainName field metadata not found');
    }
    await entityManager.createQueryBuilder().insert().into(`${schemaName}.workflow`, [
        'id',
        'name',
        ...
        },
        {
            ...
            lastPublishedVersionId: CREATE_COMPANY_WHEN_ADDING_NEW_PERSON_WORKFLOW_VERSION_ID,
            statuses: [
                'ACTIVE'
            ],
            position: 2,
    ...
    await entityManager.createQueryBuilder().insert().into(`${schemaName}.workflowVersion`, [
        'id',
        'name',
        'trigger',
        'steps',
    ...
    ]).orIgnore().values([
        {
            ...
            trigger: JSON.stringify({
                ...
                nextStepIds: [
                    '6e089bc9-aabd-435f-865f-f31c01c8f4a7'
                ]
            }),
                    ...
                    settings: {
                        input: {
                            ...
                            objectRecord: {
                                ...
                                domainName: {
                                    primaryLinkUrl: '{{6e089bc9-aabd-435f-865f-f31c01c8f4a7.companyDomain}}',
                                    primaryLinkLabel: ''
                                }
                            }
                        },
        ...
        },
        {
            ...
            trigger: JSON.stringify({
                ...
                settings: {
                    ...
                    outputSchema: (0, _generatefakeobjectrecordevent.generateFakeObjectRecordEvent)({
                        flatObjectMetadata: personObjectMetadata,
                        flatObjectMetadataMaps,
                        flatFieldMetadataMaps
                ...
                nextStepIds: [
                    'c30d7cbe-00e0-4966-bc1a-99b0a11a2cca'
                ]
            }),
            steps: JSON.stringify([
                {
                    ...
                    __typename: 'WorkflowAction',
                    nextStepIds: [
                        '01f3db05-aae5-4e4b-b361-96684f09c704'
                    ]
                },
                {
                            ...
                            stepFilters: [
                                {
                                    ...
                                    operand: 'IS',
                                    isFullRecord: false,
                                    stepOutputKey: '{{c30d7cbe-00e0-4966-bc1a-99b0a11a2cca.isPersonal}}',
                    ...
                    __typename: 'WorkflowAction',
                    nextStepIds: [
                        '1b01193b-8300-4d79-940b-44464bf45505'
                    ]
                },
                {
                    ...
                    __typename: 'WorkflowAction',
                    nextStepIds: [
                        'becb3acf-79bb-4672-8a42-3696e94957b5'
                    ]
                },
                {
                    ...
                    __typename: 'WorkflowAction',
                    nextStepIds: [
                        '9d0b6ef2-aad2-4853-92e1-95f2abf10d5b'
                    ]
                },
                {
                    ...
                    __typename: 'WorkflowAction',
                    nextStepIds: [
                        '0c99a900-656a-40e8-977e-5a7357be33b9'
                    ]
                },
                {
                        ...
                        input: {
                            branches: [
                                ...
                                },
                                {
                                    ...
                                    nextStepIds: [
                                        'ddafb9db-a94f-40b9-a5c9-becce857edf7'
                                    ]
                                }
                            ],
                            stepFilters: [
                                {
                                    ...
                                    operand: 'IS',
                                    isFullRecord: false,
                                    stepOutputKey: '{{9d0b6ef2-aad2-4853-92e1-95f2abf10d5b.hasMatch}}',
                ...
                },
                {
                        ...
                        input: {
                            ...
                            objectRecord: {
                                ...
                                domainName: {
                                    ...
                                    primaryLinkLabel: '{{1b01193b-8300-4d79-940b-44464bf45505.domain}}'
                                }
                            }
                        },
                        outputSchema: {},
                    ...
                    __typename: 'WorkflowAction',
                    nextStepIds: [
                        'd5d5d6e1-391f-4142-83c1-670f7087f079'
                    ]
                },
                {
    ...
    await entityManager.createQueryBuilder().insert().into(`${schemaName}.workflowAutomatedTrigger`, [
        'id',
        'workflowId',
        'type',
        'settings'
...
//# sourceMappingURL=prefill-workflows.util.js.map