...
Object.defineProperty(exports, "STANDARD_FLAT_SKILL_METADATA_BUILDERS_BY_SKILL_NAME", {
    enumerable: true,
    get: function() {
        return STANDARD_FLAT_SKILL_METADATA_BUILDERS_BY_SKILL_NAME;
    }
});
const _createstandardskillflatmetadatautil = require("./create-standard-skill-flat-metadata.util");
const STANDARD_FLAT_SKILL_METADATA_BUILDERS_BY_SKILL_NAME = {
    'workflow-building': (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'workflow-building',
                name: 'workflow-building',
                label: 'Workflow Building',
                description: 'Creating and managing automation workflows with triggers and steps',
...
Prioritize user understanding and workflow effectiveness.`,
    ...
    'data-manipulation': (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'data-manipulation',
                name: 'data-manipulation',
                label: 'Data Manipulation',
                description: 'Searching, filtering, creating, and updating records across all objects',
                icon: 'IconDatabase',
...
Prioritize data integrity and provide clear feedback on operations performed.`,
    ...
    'workspace-demo-seeding': (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'workspace-demo-seeding',
                name: 'workspace-demo-seeding',
                label: 'Workspace Demo Seeding',
                description: 'Seeding demo metadata and data for workspace setup and testing purposes',
                icon: 'IconDatabase',
...
`,
    ...
    'dashboard-building': (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
...
- When modifying a chart, confirm whether the user wants to change settings or change chart type`,
    ...
    'metadata-building': (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'metadata-building',
                name: 'metadata-building',
                label: 'Metadata Building',
                description: 'Managing the data model: creating objects, fields, and relations',
...
Prioritize data model integrity and user understanding.`,
    ...
    research: (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'research',
                name: 'research',
...
Be persistent in finding accurate information.`,
    ...
    'code-interpreter': (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'code-interpreter',
                name: 'code-interpreter',
                label: 'Code Interpreter',
                description: 'Python code execution for data analysis, complex multi-step operations, and efficient bulk processing via MCP bridge',
                icon: 'IconCode',
...
This allows you to orchestrate complex multi-step operations in a single code execution, which is more efficient than multiple tool calls.`,
    ...
    xlsx: (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'xlsx',
                name: 'xlsx',
                label: 'Excel & Spreadsheets',
                description: 'Excel/spreadsheet creation, editing, and analysis with formulas, formatting, and visualization',
...
| Recalculate | script | \`python /home/user/scripts/xlsx/recalc.py file.xlsx\` |`,
    ...
    pdf: (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'pdf',
                name: 'pdf',
                label: 'PDF Processing',
                description: 'PDF form filling, field extraction, table parsing, and validation',
...
| Merge PDFs | PyPDF2 | \`PdfMerger()\` |`,
    ...
    docx: (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'docx',
                name: 'docx',
                label: 'Word Documents',
                description: 'Word document creation, editing, template processing, and OOXML manipulation',
...
| Validate | script | \`python validate.py doc.docx\` |`,
    ...
    pptx: (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'pptx',
                name: 'pptx',
                label: 'PowerPoint',
                description: 'PowerPoint creation, editing, templates, thumbnails, and slide manipulation',
...
//# sourceMappingURL=create-standard-flat-skill-metadata.util.js.map