...
Object.defineProperty(exports, "buildFavoriteFolderStandardFlatFieldMetadatas", {
    enumerable: true,
    get: function() {
        return buildFavoriteFolderStandardFlatFieldMetadatas;
    }
});
...
const _favoritefolderworkspaceentity = require("../../../../../modules/favorite-folder/standard-objects/favorite-folder.workspace-entity");
const buildFavoriteFolderStandardFlatFieldMetadatas = ({ now, objectName, workspaceId, standardObjectMetadataRelatedEntityIds, dependencyFlatEntityMaps, twentyStandardApplicationId })=>({
        ...
        position: (0, _createstandardfieldflatmetadatautil.createStandardFieldFlatMetadata)({
            ...
            context: {
                ...
                description: (0, _i18nlabelutil.i18nLabel)(/*i18n*/ {
                    id: "WDVfUH",
                    message: "Favorite folder position"
                }),
                icon: 'IconHierarchy2',
                isSystem: true,
                isNullable: false,
        ...
        searchVector: (0, _createstandardfieldflatmetadatautil.createStandardFieldFlatMetadata)({
            ...
            context: {
                ...
                settings: {
                    ...
                    asExpression: (0, _gettsvectorcolumnexpressionutil.getTsVectorColumnExpressionFromFields)(_favoritefolderworkspaceentity.SEARCH_FIELDS_FOR_FAVORITE_FOLDER)
                }
            },
            standardObjectMetadataRelatedEntityIds,
            dependencyFlatEntityMaps,
        ...
        name: (0, _createstandardfieldflatmetadatautil.createStandardFieldFlatMetadata)({
            ...
            context: {
                ...
                description: (0, _i18nlabelutil.i18nLabel)(/*i18n*/ {
                    id: "EEVPOx",
                    message: "Name of the favorite folder"
                }),
                icon: 'IconText',
                isNullable: true,
                isUIReadOnly: true
        ...
        favorites: (0, _createstandardrelationfieldflatmetadatautil.createStandardRelationFieldFlatMetadata)({
            ...
            context: {
                ...
                description: (0, _i18nlabelutil.i18nLabel)(/*i18n*/ {
                    id: "0CzeFL",
                    message: "Favorites in this folder"
                }),
                icon: 'IconHeart',
                isNullable: false,
                isUIReadOnly: true,
...
//# sourceMappingURL=compute-favorite-folder-standard-flat-field-metadata.util.js.map