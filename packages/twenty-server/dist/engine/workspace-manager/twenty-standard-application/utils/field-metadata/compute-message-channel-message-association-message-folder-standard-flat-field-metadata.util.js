...
Object.defineProperty(exports, "buildMessageChannelMessageAssociationMessageFolderStandardFlatFieldMetadatas", {
    enumerable: true,
    get: function() {
        return buildMessageChannelMessageAssociationMessageFolderStandardFlatFieldMetadatas;
    }
});
...
const _messagechannelmessageassociationmessagefolderworkspaceentity = require("../../../../../modules/messaging/common/standard-objects/message-channel-message-association-message-folder.workspace-entity");
const buildMessageChannelMessageAssociationMessageFolderStandardFlatFieldMetadatas = ({ now, objectName, workspaceId, standardObjectMetadataRelatedEntityIds, dependencyFlatEntityMaps, twentyStandardApplicationId })=>({
        ...
        searchVector: (0, _createstandardfieldflatmetadatautil.createStandardFieldFlatMetadata)({
            ...
            context: {
                ...
                settings: {
                    ...
                    asExpression: (0, _gettsvectorcolumnexpressionutil.getTsVectorColumnExpressionFromFields)(_messagechannelmessageassociationmessagefolderworkspaceentity.SEARCH_FIELDS_FOR_MESSAGE_CHANNEL_MESSAGE_ASSOCIATION_MESSAGE_FOLDER)
                }
            },
            standardObjectMetadataRelatedEntityIds,
            dependencyFlatEntityMaps,
        ...
        messageChannelMessageAssociation: (0, _createstandardrelationfieldflatmetadatautil.createStandardRelationFieldFlatMetadata)({
            objectName,
            workspaceId,
            context: {
        ...
        messageFolder: (0, _createstandardrelationfieldflatmetadatautil.createStandardRelationFieldFlatMetadata)({
            objectName,
            workspaceId,
            context: {
                type: _types.FieldMetadataType.RELATION,
...
//# sourceMappingURL=compute-message-channel-message-association-message-folder-standard-flat-field-metadata.util.js.map