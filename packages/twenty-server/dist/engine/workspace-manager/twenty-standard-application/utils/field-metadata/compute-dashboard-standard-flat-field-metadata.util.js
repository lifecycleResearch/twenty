...
Object.defineProperty(exports, "buildDashboardStandardFlatFieldMetadatas", {
    enumerable: true,
    get: function() {
        return buildDashboardStandardFlatFieldMetadatas;
    }
});
...
const _dashboardworkspaceentity = require("../../../../../modules/dashboard/standard-objects/dashboard.workspace-entity");
const buildDashboardStandardFlatFieldMetadatas = ({ now, objectName, workspaceId, standardObjectMetadataRelatedEntityIds, dependencyFlatEntityMaps, twentyStandardApplicationId })=>({
        ...
        pageLayoutId: (0, _createstandardfieldflatmetadatautil.createStandardFieldFlatMetadata)({
            objectName,
            workspaceId,
            context: {
        ...
        searchVector: (0, _createstandardfieldflatmetadatautil.createStandardFieldFlatMetadata)({
            ...
            context: {
                ...
                settings: {
                    ...
                    asExpression: (0, _gettsvectorcolumnexpressionutil.getTsVectorColumnExpressionFromFields)(_dashboardworkspaceentity.SEARCH_FIELDS_FOR_DASHBOARD)
                }
            },
            standardObjectMetadataRelatedEntityIds,
            dependencyFlatEntityMaps,
        ...
        favorites: (0, _createstandardrelationfieldflatmetadatautil.createStandardRelationFieldFlatMetadata)({
            ...
            context: {
                ...
                description: (0, _i18nlabelutil.i18nLabel)(/*i18n*/ {
                    id: "5zuBdE",
                    message: "Favorites linked to the dashboard"
                }),
                icon: 'IconHeart',
                isNullable: false,
...
//# sourceMappingURL=compute-dashboard-standard-flat-field-metadata.util.js.map