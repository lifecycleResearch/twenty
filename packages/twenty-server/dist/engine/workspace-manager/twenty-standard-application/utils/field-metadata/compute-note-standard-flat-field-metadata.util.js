...
const _noteworkspaceentity = require("../../../../../modules/note/standard-objects/note.workspace-entity");
const buildNoteStandardFlatFieldMetadatas = ({ now, objectName, workspaceId, standardObjectMetadataRelatedEntityIds, dependencyFlatEntityMaps, twentyStandardApplicationId })=>({
        ...
        searchVector: (0, _createstandardfieldflatmetadatautil.createStandardFieldFlatMetadata)({
            ...
            context: {
                ...
                settings: {
                    ...
                    asExpression: (0, _gettsvectorcolumnexpressionutil.getTsVectorColumnExpressionFromFields)(_noteworkspaceentity.SEARCH_FIELDS_FOR_NOTES)
                }
            },
            standardObjectMetadataRelatedEntityIds,
            dependencyFlatEntityMaps,
        ...
        favorites: (0, _createstandardrelationfieldflatmetadatautil.createStandardRelationFieldFlatMetadata)({
            ...
            context: {
                ...
                description: (0, _i18nlabelutil.i18nLabel)(/*i18n*/ {
                    id: "GOfcBt",
                    message: "Favorites linked to the note"
                }),
                icon: 'IconHeart',
                isNullable: false,
