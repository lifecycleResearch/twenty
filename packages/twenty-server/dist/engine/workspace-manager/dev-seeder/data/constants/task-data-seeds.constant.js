...
_export(exports, {
    ...
    get TASK_DATA_SEED_COLUMNS () {
        return TASK_DATA_SEED_COLUMNS;
    },
    get TASK_DATA_SEED_IDS () {
        return TASK_DATA_SEED_IDS;
    }
});
const _workspacememberdataseedsconstant = require("./workspace-member-data-seeds.constant");
const TASK_DATA_SEED_COLUMNS = [
    'id',
    'position',
    'title',
    'bodyV2Blocknote',
...
const TASK_DATA_SEED_IDS = GENERATE_TASK_IDS();
...
const GET_RANDOM_ASSIGNEE = ()=>{
    const MEMBERS = [
        _workspacememberdataseedsconstant.WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
        _workspacememberdataseedsconstant.WORKSPACE_MEMBER_DATA_SEED_IDS.JONY,
        _workspacememberdataseedsconstant.WORKSPACE_MEMBER_DATA_SEED_IDS.PHIL
    ];
    return MEMBERS[Math.floor(Math.random() * MEMBERS.length)];
};
// Helper function to format due date
const FORMAT_DUE_DATE = (daysFromNow)=>{
...
const TASK_DATA_SEEDS = GENERATE_TASK_SEEDS();

//# sourceMappingURL=task-data-seeds.constant.js.map