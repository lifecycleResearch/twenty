...
_export(exports, {
    get SURVEY_RESULT_DATA_SEEDS () {
        return SURVEY_RESULT_DATA_SEEDS;
    },
    get SURVEY_RESULT_DATA_SEED_COLUMNS () {
        return SURVEY_RESULT_DATA_SEED_COLUMNS;
    },
    get SURVEY_RESULT_DATA_SEED_IDS () {
        return SURVEY_RESULT_DATA_SEED_IDS;
    }
});
const SURVEY_RESULT_DATA_SEED_COLUMNS = [
    'id',
    'name',
    'score',
...
const SURVEY_RESULT_DATA_SEED_IDS = {
...
const SURVEY_RESULT_DATA_SEEDS = [
    {
        ...
        participants: 599,
        averageEstimatedNumberOfAtomsInTheUniverse: '78667671999742413888718514892176090137414339407788865817757694662213423853',
        comments: 'Fuga agnosco patria volva aqua angustus utpote acquiro bestia. Abduco vorax volva agnosco alioqui. Cupiditas abbas aptus uterque bibo sonitus. Tergum carpo degero defaeco. Nostrum verumtamen tactus arbustum tui administratio. Terra sollers calculus blandior. Trans supra tricesimus. Utrum tenus comis adeo asporto sto quibusdam theologus suppono. Cursim casso alveus validus vapulus acer vis. Velum traho adipisci coerceo terminatio at allatus turbo adnuo blandior. Ante consectetur cedo cibo perferendis at amicitia degenero. Doloremque votum cupressus cerno stillicidium arcesso abundans antea sumo. Spoliatio asper solus. Vespillo distinctio ver truculenter torqueo vado aureus. Eaque bonus occaecati defungo defetiscor cibo. Thema ager usus verbum caute tergeo earum adipiscor vinculum. Delinquo tardus canonicus abbas amo confugo doloremque. Comburo quos cumque inflammatio dignissimos abstergo ventus cruentus. Tabula aliquid contego sono delectatio aeternus. Summopere crinis debitis stella conservo desipio termes vulgaris.',
    ...
    },
    {
        ...
        participants: 575,
        averageEstimatedNumberOfAtomsInTheUniverse: '58714201303231867082632874445965836504227665636297405101762256297406500076',
    ...
    },
    {
        ...
        participants: 590,
        averageEstimatedNumberOfAtomsInTheUniverse: '51790645279092482632713239096036038617511762830423654232543291815995800207',
...
//# sourceMappingURL=survey-result-data-seeds.constant.js.map