...
_export(exports, {
    ...
    get PET_DATA_SEED_COLUMNS () {
        return PET_DATA_SEED_COLUMNS;
    },
    get PET_DATA_SEED_IDS () {
        return PET_DATA_SEED_IDS;
    }
});
const PET_DATA_SEED_COLUMNS = [
    'id',
    'name',
    'species',
    'traits',
...
const PET_DATA_SEED_IDS = {
    ID_1: '20202020-0f2a-49d8-8aa2-ec8786153a0b'
};
const PET_DATA_SEEDS = [
    {
        ...
        picturesPrimaryLinkUrl: 'https://images.unsplash.com/photo-1507146426996-ef05306b995a?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        ...
        extraData: JSON.stringify({
            settingsOnVetSoftware: {
                ...
                settings: [
                    ...
                    {
                        key: 'Vet address',
                        value: '513 Batz Fork, 7344 Haley Loop, Jacksonstad, North Dakota, 32048-5208, United States'
                    }
                ]
            },
            additionalData: [
...
//# sourceMappingURL=pet-data-seeds.constant.js.map