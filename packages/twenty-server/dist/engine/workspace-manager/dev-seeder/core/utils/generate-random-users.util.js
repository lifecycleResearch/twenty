...
Object.defineProperty(exports, "generateRandomUsers", {
    enumerable: true,
    get: function() {
...
function generateRandomUsers() {
    ...
    const passwordHash = '$2b$10$3LwXjJRtLsfx4hLuuXhxt.3mWgismTiZFCZSG3z9kDrSfsrBl0fT6';
    for(let i = 1; i <= 1000; i++){
        // Generate deterministic random indices for names
        const firstNameIndex = Math.floor(seededRandom(i * 1000) * FIRST_NAMES.length);
        const lastNameIndex = Math.floor(seededRandom(i * 2000) * LAST_NAMES.length);
        const colorSchemeIndex = Math.floor(seededRandom(i * 3000) * COLOR_SCHEMES.length);
        ...
        const userId = `30303030-${i.toString().padStart(4, '0')}-4000-8000-000000000000`.replace(/0{4}-4000-8000-000000000000$/, ()=>{
            const hex = (i * 12345).toString(16).padStart(12, '0').slice(0, 12);
            return `${hex.slice(0, 4)}-4000-8000-${hex.slice(4, 12)}`;
        });
        const userWorkspaceId = `31313131-${i.toString().padStart(4, '0')}-4000-8000-000000000000`.replace(/0{4}-4000-8000-000000000000$/, ()=>{
            const hex = (i * 23456).toString(16).padStart(12, '0').slice(0, 12);
            return `${hex.slice(0, 4)}-4000-8000-${hex.slice(4, 12)}`;
        });
        const workspaceMemberId = `32323232-${i.toString().padStart(4, '0')}-4000-8000-000000000000`.replace(/0{4}-4000-8000-000000000000$/, ()=>{
...
//# sourceMappingURL=generate-random-users.util.js.map