...
Object.defineProperty(exports, "UpdatePermissionFlagActionHandlerService", {
    enumerable: true,
    get: function() {
        return UpdatePermissionFlagActionHandlerService;
    }
});
...
let UpdatePermissionFlagActionHandlerService = class UpdatePermissionFlagActionHandlerService extends (0, _workspacemigrationrunneractionhandlerserviceinterface.WorkspaceMigrationRunnerActionHandler)('update', 'permissionFlag') {
    async transpileUniversalActionToFlatAction(context) {
        const { action, allFlatEntityMaps } = context;
        const flatPermissionFlag = (0, _findflatentitybyuniversalidentifierorthrowutil.findFlatEntityByUniversalIdentifierOrThrow)({
...
UpdatePermissionFlagActionHandlerService = _ts_decorate([
    (0, _common.Injectable)(),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [])
], UpdatePermissionFlagActionHandlerService);

//# sourceMappingURL=update-permission-flag-action-handler.service.js.map