...
Object.defineProperty(exports, "CreateViewFilterActionHandlerService", {
    enumerable: true,
    get: function() {
        return CreateViewFilterActionHandlerService;
    }
});
...
let CreateViewFilterActionHandlerService = class CreateViewFilterActionHandlerService extends (0, _workspacemigrationrunneractionhandlerserviceinterface.WorkspaceMigrationRunnerActionHandler)('create', 'viewFilter') {
    async transpileUniversalActionToFlatAction({ action, allFlatEntityMaps, flatApplication, workspaceId }) {
        const { fieldMetadataId, viewId, viewFilterGroupId } = (0, _resolveuniversalrelationidentifierstoidsutil.resolveUniversalRelationIdentifiersToIds)({
...
CreateViewFilterActionHandlerService = _ts_decorate([
    (0, _common.Injectable)()
], CreateViewFilterActionHandlerService);

//# sourceMappingURL=create-view-filter-action-handler.service.js.map