...
Object.defineProperty(exports, "UpdateFrontComponentActionHandlerService", {
    enumerable: true,
    get: function() {
        return UpdateFrontComponentActionHandlerService;
    }
});
...
let UpdateFrontComponentActionHandlerService = class UpdateFrontComponentActionHandlerService extends (0, _workspacemigrationrunneractionhandlerserviceinterface.WorkspaceMigrationRunnerActionHandler)('update', 'frontComponent') {
    async transpileUniversalActionToFlatAction(context) {
        const { action, allFlatEntityMaps } = context;
        const flatFrontComponent = (0, _findflatentitybyuniversalidentifierorthrowutil.findFlatEntityByUniversalIdentifierOrThrow)({
...
UpdateFrontComponentActionHandlerService = _ts_decorate([
    (0, _common.Injectable)()
], UpdateFrontComponentActionHandlerService);

//# sourceMappingURL=update-front-component-action-handler.service.js.map