...
const _validateflatentitycirculardependencyutil = require("../validate-flat-entity-circular-dependency.util");
const createUniversalFlatEntityMaps = (entities)=>({
        byUniversalIdentifier: Object.fromEntries(entities.map((entity)=>[
                entity.universalIdentifier,
                entity
            ]))
    });
const createTestEntity = (universalIdentifier, parentUniversalIdentifier = null)=>({
...
const testCases = [
    ...
    },
    {
        ...
        context: {
            ...
            entities: [
                createTestEntity('entity-parent', null)
            ],
            expected: {
                status: 'success',
                depth: 2
    ...
    {
        title: 'should fail with circular_dependency when parent points back to entity',
        context: {
    ...
    {
        title: 'should fail with circular_dependency when chain creates a cycle (A -> B -> C -> A)',
        context: {
            flatEntityUniversalIdentifier: 'entity-a',
            flatEntityParentUniversalIdentifier: 'entity-b',
            entities: [
    ...
    {
        title: 'should fail with circular_dependency when ancestors form a cycle among themselves',
        context: {
    ...
    {
        title: 'should check max depth before circular dependency to prevent infinite loop',
        context: {
            flatEntityUniversalIdentifier: 'entity-new',
            flatEntityParentUniversalIdentifier: 'entity-a',
            maxDepth: 2,
...
describe('validateFlatEntityCircularDependency', ()=>{
    test.each(testCases)('$title', ({ context })=>{
        ...
        const result = (0, _validateflatentitycirculardependencyutil.validateFlatEntityCircularDependency)({
            flatEntityUniversalIdentifier: context.flatEntityUniversalIdentifier,
            flatEntityParentUniversalIdentifier: context.flatEntityParentUniversalIdentifier,
...
//# sourceMappingURL=validate-flat-entity-circular-dependency.util.spec.js.map