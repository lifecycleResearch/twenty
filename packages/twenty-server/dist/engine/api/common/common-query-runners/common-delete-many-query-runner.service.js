...
Object.defineProperty(exports, "CommonDeleteManyQueryRunnerService", {
    enumerable: true,
    get: function() {
        return CommonDeleteManyQueryRunnerService;
    }
});
...
let CommonDeleteManyQueryRunnerService = class CommonDeleteManyQueryRunnerService extends _commonbasequeryrunnerservice.CommonBaseQueryRunnerService {
    async run(args, queryRunnerContext) {
        ...
        const deletedObjectRecords = await queryBuilder.softDelete().returning(columnsToReturn).execute();
        const deletedRecords = deletedObjectRecords.generatedMaps;
    ...
    constructor(...args){
        super(...args), this.operationName = _commonqueryargstype.CommonQueryNames.DELETE_MANY;
    }
};
CommonDeleteManyQueryRunnerService = _ts_decorate([
    (0, _common.Injectable)()
], CommonDeleteManyQueryRunnerService);

//# sourceMappingURL=common-delete-many-query-runner.service.js.map