...
Object.defineProperty(exports, "failingInputsByFieldMetadataType", {
    enumerable: true,
    get: function() {
        return failingInputsByFieldMetadataType;
    }
});
...
const failingInputsByFieldMetadataType = {
    ...
    [_types.FieldMetadataType.MORPH_RELATION]: [
        {
            input: {
                [_setuptestobjectswithallfieldtypesutil.joinColumnNameForManyToOneMorphRelationField1]: 'not-a-morph-relation'
            }
        },
        {
            input: {
        ...
        {
            input: {
                [_setuptestobjectswithallfieldtypesutil.joinColumnNameForManyToOneMorphRelationField1]: true
            }
        },
        {
            input: {
                [_setuptestobjectswithallfieldtypesutil.joinColumnNameForManyToOneMorphRelationField1]: 1
            }
        }
    ],
...
//# sourceMappingURL=failing-inputs-by-field-metadata-type.constant.js.map