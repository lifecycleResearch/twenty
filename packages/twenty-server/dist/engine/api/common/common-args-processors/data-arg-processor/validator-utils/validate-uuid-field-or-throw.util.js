...
const validateUUIDFieldOrThrow = (value, fieldName)=>{
    if (!(0, _guards.isNonEmptyString)(value) && !(0, _guards.isNull)(value) || (0, _guards.isNonEmptyString)(value) && !(0, _utils.isValidUuid)(value)) {
        ...
        throw new _commonqueryrunnerexception.CommonQueryRunnerException(`Invalid UUID value ${inspectedValue} for field "${fieldName}"`, _commonqueryrunnerexception.CommonQueryRunnerExceptionCode.INVALID_ARGS_DATA, {
