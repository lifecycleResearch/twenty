...
const validateNumberFieldOrThrow = (value, fieldName)=>{
    if (!(0, _guards.isNumber)(value) && !(0, _guards.isNull)(value) || (0, _guards.isNumber)(value) && (isNaN(value) || value === Infinity || value === -Infinity)) {
        ...
        throw new _commonqueryrunnerexception.CommonQueryRunnerException(`Invalid number value ${inspectedValue} for field "${fieldName}"`, _commonqueryrunnerexception.CommonQueryRunnerExceptionCode.INVALID_ARGS_FILTER, {
