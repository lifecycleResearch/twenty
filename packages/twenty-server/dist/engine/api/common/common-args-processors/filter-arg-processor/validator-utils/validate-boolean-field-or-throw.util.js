...
const validateBooleanFieldOrThrow = (value, fieldName)=>{
    if (!(0, _guards.isBoolean)(value) && !(0, _guards.isNull)(value)) {
        ...
        throw new _commonqueryrunnerexception.CommonQueryRunnerException(`Invalid boolean value ${(0, _util.inspect)(value)} for field "${fieldName}"`, _commonqueryrunnerexception.CommonQueryRunnerExceptionCode.INVALID_ARGS_FILTER, {
