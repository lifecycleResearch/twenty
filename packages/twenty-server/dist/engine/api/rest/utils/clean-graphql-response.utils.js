...
Object.defineProperty(exports, "cleanGraphQLResponse", {
    enumerable: true,
    get: function() {
        ...
        Object.keys(obj).forEach((key)=>{
            if (isObject(obj[key])) {
                if (obj[key].edges) {
                    ...
                    cleanedObj[key] = obj[key].edges.map((edge)=>cleanObject(edge.node));
                } else {
...
//# sourceMappingURL=clean-graphql-response.utils.js.map