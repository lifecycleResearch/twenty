...
Object.defineProperty(exports, "RestoreManyResolverFactory", {
    enumerable: true,
    get: function() {
        return RestoreManyResolverFactory;
    }
});
...
let RestoreManyResolverFactory = class RestoreManyResolverFactory {
    create(context) {
    ...
    constructor(commonRestoreManyQueryRunnerService){
        this.commonRestoreManyQueryRunnerService = commonRestoreManyQueryRunnerService;
    }
};
RestoreManyResolverFactory.methodName = _resolvermethodnames.RESOLVER_METHOD_NAMES.RESTORE_MANY;
RestoreManyResolverFactory = _ts_decorate([
...
//# sourceMappingURL=restore-many-resolver.factory.js.map