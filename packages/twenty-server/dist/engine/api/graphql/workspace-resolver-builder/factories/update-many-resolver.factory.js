...
Object.defineProperty(exports, "UpdateManyResolverFactory", {
    enumerable: true,
    get: function() {
        return UpdateManyResolverFactory;
    }
});
...
let UpdateManyResolverFactory = class UpdateManyResolverFactory {
    ...
    constructor(commonUpdateManyQueryRunnerService){
        this.commonUpdateManyQueryRunnerService = commonUpdateManyQueryRunnerService;
    }
};
UpdateManyResolverFactory.methodName = _resolvermethodnames.RESOLVER_METHOD_NAMES.UPDATE_MANY;
UpdateManyResolverFactory = _ts_decorate([
