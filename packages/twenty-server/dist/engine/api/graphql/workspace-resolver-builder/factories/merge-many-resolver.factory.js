...
Object.defineProperty(exports, "MergeManyResolverFactory", {
    enumerable: true,
    get: function() {
        return MergeManyResolverFactory;
    }
});
...
let MergeManyResolverFactory = class MergeManyResolverFactory {
    create(context) {
    ...
    constructor(commonMergeManyQueryRunnerService){
        this.commonMergeManyQueryRunnerService = commonMergeManyQueryRunnerService;
    }
};
MergeManyResolverFactory.methodName = _resolvermethodnames.RESOLVER_METHOD_NAMES.MERGE_MANY;
MergeManyResolverFactory = _ts_decorate([
...
//# sourceMappingURL=merge-many-resolver.factory.js.map