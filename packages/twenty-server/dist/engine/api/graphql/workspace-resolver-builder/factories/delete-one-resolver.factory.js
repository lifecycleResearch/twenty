...
Object.defineProperty(exports, "DeleteOneResolverFactory", {
    enumerable: true,
    get: function() {
        return DeleteOneResolverFactory;
    }
});
...
let DeleteOneResolverFactory = class DeleteOneResolverFactory {
    ...
    constructor(commonDeleteOneQueryRunnerService){
        this.commonDeleteOneQueryRunnerService = commonDeleteOneQueryRunnerService;
    }
};
DeleteOneResolverFactory.methodName = _resolvermethodnames.RESOLVER_METHOD_NAMES.DELETE_ONE;
DeleteOneResolverFactory = _ts_decorate([
