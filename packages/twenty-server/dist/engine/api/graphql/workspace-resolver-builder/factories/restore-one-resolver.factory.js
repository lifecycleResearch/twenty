...
Object.defineProperty(exports, "RestoreOneResolverFactory", {
    enumerable: true,
    get: function() {
        return RestoreOneResolverFactory;
    }
});
...
let RestoreOneResolverFactory = class RestoreOneResolverFactory {
    create(context) {
    ...
    constructor(commonRestoreOneQueryRunnerService){
        this.commonRestoreOneQueryRunnerService = commonRestoreOneQueryRunnerService;
    }
};
RestoreOneResolverFactory.methodName = _resolvermethodnames.RESOLVER_METHOD_NAMES.RESTORE_ONE;
RestoreOneResolverFactory = _ts_decorate([
...
//# sourceMappingURL=restore-one-resolver.factory.js.map