...
Object.defineProperty(exports, "DestroyOneResolverFactory", {
    enumerable: true,
    get: function() {
        return DestroyOneResolverFactory;
    }
});
...
let DestroyOneResolverFactory = class DestroyOneResolverFactory {
    create(context) {
    ...
    constructor(commonDestroyOneQueryRunnerService){
        this.commonDestroyOneQueryRunnerService = commonDestroyOneQueryRunnerService;
    }
};
DestroyOneResolverFactory.methodName = _resolvermethodnames.RESOLVER_METHOD_NAMES.DESTROY_ONE;
DestroyOneResolverFactory = _ts_decorate([
...
//# sourceMappingURL=destroy-one-resolver.factory.js.map