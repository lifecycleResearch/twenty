...
Object.defineProperty(exports, "EnumFieldMetadataGqlEnumTypeGenerator", {
    enumerable: true,
    get: function() {
        return EnumFieldMetadataGqlEnumTypeGenerator;
    }
});
...
let EnumFieldMetadataGqlEnumTypeGenerator = class EnumFieldMetadataGqlEnumTypeGenerator {
    buildAndStore(flatObjectMetadata, fields) {
        for (const fieldMetadata of fields){
            ...
            this.gqlTypesStorage.addGqlType((0, _computeenumfieldgqltypekeyutil.computeEnumFieldGqlTypeKey)(flatObjectMetadata.nameSingular, fieldMetadata.name), this.generateEnum(flatObjectMetadata.nameSingular, fieldMetadata));
        }
    }
    generateEnum(objectName, fieldMetadata) {
        // FixMe: It's a hack until Typescript get fixed on union types for reduce function
        // https://github.com/microsoft/TypeScript/issues/36390
        const enumOptions = (0, _transformenumvalue.transformEnumValue)(fieldMetadata.options ?? undefined);
        if (!(0, _utils.isDefined)(enumOptions)) {
        ...
        return new _graphql.GraphQLEnumType({
            name: `${(0, _utils.pascalCase)(objectName)}${(0, _utils.pascalCase)(fieldMetadata.name)}Enum`,
    ...
    constructor(gqlTypesStorage){
        ...
        this.logger = new _common.Logger(EnumFieldMetadataGqlEnumTypeGenerator.name);
    }
};
EnumFieldMetadataGqlEnumTypeGenerator = _ts_decorate([
...
//# sourceMappingURL=enum-field-metadata-gql-enum-type.generator.js.map