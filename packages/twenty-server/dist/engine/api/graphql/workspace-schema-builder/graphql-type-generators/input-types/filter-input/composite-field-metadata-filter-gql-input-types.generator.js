...
Object.defineProperty(exports, "CompositeFieldMetadataFilterGqlInputTypeGenerator", {
    enumerable: true,
    get: function() {
        return CompositeFieldMetadataFilterGqlInputTypeGenerator;
    }
});
...
let CompositeFieldMetadataFilterGqlInputTypeGenerator = class CompositeFieldMetadataFilterGqlInputTypeGenerator {
    buildAndStore(compositeType) {
        const key = (0, _computecompositefieldinputtypekeyutil.computeCompositeFieldInputTypeKey)(compositeType.type, _gqlinputtypedefinitionkindenum.GqlInputTypeDefinitionKind.Filter);
        const type = new _graphql.GraphQLInputObjectType({
            name: `${(0, _utils.pascalCase)(compositeType.type)}${_gqlinputtypedefinitionkindenum.GqlInputTypeDefinitionKind.Filter.toString()}Input`,
    ...
    generateFields(compositeType) {
        ...
        for (const property of compositeType.properties){
            ...
            if ((0, _isenumfieldmetadatatypeutil.isEnumFieldMetadataType)(property.type)) {
                ...
                type = (0, _creategqlenumfiltertypeutil.createGqlEnumFilterType)(enumType);
            } else {
                type = this.typeMapperService.mapToFilterType(property.type, typeOptions);
            }
    ...
    constructor(gqlTypesStorage, typeMapperService){
        ...
        this.logger = new _common.Logger(CompositeFieldMetadataFilterGqlInputTypeGenerator.name);
    }
};
CompositeFieldMetadataFilterGqlInputTypeGenerator = _ts_decorate([
...
//# sourceMappingURL=composite-field-metadata-filter-gql-input-types.generator.js.map