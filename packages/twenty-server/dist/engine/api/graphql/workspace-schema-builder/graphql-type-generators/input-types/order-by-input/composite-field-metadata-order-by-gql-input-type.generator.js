...
Object.defineProperty(exports, "CompositeFieldMetadataOrderByGqlInputTypeGenerator", {
    enumerable: true,
    get: function() {
        return CompositeFieldMetadataOrderByGqlInputTypeGenerator;
    }
});
...
let CompositeFieldMetadataOrderByGqlInputTypeGenerator = class CompositeFieldMetadataOrderByGqlInputTypeGenerator {
    buildAndStore(compositeType) {
        const key = (0, _computecompositefieldinputtypekeyutil.computeCompositeFieldInputTypeKey)(compositeType.type, _gqlinputtypedefinitionkindenum.GqlInputTypeDefinitionKind.OrderBy);
        const type = new _graphql.GraphQLInputObjectType({
            name: `${(0, _utils.pascalCase)(compositeType.type)}${_gqlinputtypedefinitionkindenum.GqlInputTypeDefinitionKind.OrderBy.toString()}Input`,
    ...
    constructor(gqlTypesStorage, typeMapperService){
        ...
        this.logger = new _common.Logger(CompositeFieldMetadataOrderByGqlInputTypeGenerator.name);
    }
};
CompositeFieldMetadataOrderByGqlInputTypeGenerator = _ts_decorate([
...
//# sourceMappingURL=composite-field-metadata-order-by-gql-input-type.generator.js.map