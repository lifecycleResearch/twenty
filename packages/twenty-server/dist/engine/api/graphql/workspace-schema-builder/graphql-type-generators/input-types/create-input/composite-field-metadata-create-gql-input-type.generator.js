...
Object.defineProperty(exports, "CompositeFieldMetadataCreateGqlInputTypeGenerator", {
    enumerable: true,
    get: function() {
        return CompositeFieldMetadataCreateGqlInputTypeGenerator;
    }
});
...
let CompositeFieldMetadataCreateGqlInputTypeGenerator = class CompositeFieldMetadataCreateGqlInputTypeGenerator {
    buildAndStore(compositeType) {
        const key = (0, _computecompositefieldinputtypekeyutil.computeCompositeFieldInputTypeKey)(compositeType.type, _gqlinputtypedefinitionkindenum.GqlInputTypeDefinitionKind.Create);
        const type = new _graphql.GraphQLInputObjectType({
            name: `${(0, _utils.pascalCase)(compositeType.type)}${_gqlinputtypedefinitionkindenum.GqlInputTypeDefinitionKind.Create.toString()}Input`,
    ...
    constructor(gqlTypesStorage, typeMapperService){
        ...
        this.logger = new _common.Logger(CompositeFieldMetadataCreateGqlInputTypeGenerator.name);
    }
};
CompositeFieldMetadataCreateGqlInputTypeGenerator = _ts_decorate([
...
//# sourceMappingURL=composite-field-metadata-create-gql-input-type.generator.js.map