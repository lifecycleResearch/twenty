...
Object.defineProperty(exports, "RemoveSaveCancelRecordPageLayoutEngineKeys1773668124779", {
    enumerable: true,
    get: function() {
        return RemoveSaveCancelRecordPageLayoutEngineKeys1773668124779;
    }
});
let RemoveSaveCancelRecordPageLayoutEngineKeys1773668124779 = class RemoveSaveCancelRecordPageLayoutEngineKeys1773668124779 {
    async up(queryRunner) {
        await queryRunner.query(`DELETE FROM "core"."commandMenuItem" WHERE "engineComponentKey" IN ('SAVE_RECORD_PAGE_LAYOUT', 'CANCEL_RECORD_PAGE_LAYOUT')`);
    ...
    constructor(){
        this.name = 'RemoveSaveCancelRecordPageLayoutEngineKeys1773668124779';
    }
};

//# sourceMappingURL=1773668124779-remove-save-cancel-record-page-layout-engine-keys.js.map