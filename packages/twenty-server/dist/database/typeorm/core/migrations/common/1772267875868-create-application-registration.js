...
Object.defineProperty(exports, "CreateApplicationRegistration1772267875868", {
    enumerable: true,
    get: function() {
        return CreateApplicationRegistration1772267875868;
    }
});
let CreateApplicationRegistration1772267875868 = class CreateApplicationRegistration1772267875868 {
    ...
    `);
        await queryRunner.query(`ALTER TABLE "core"."application" ADD "applicationRegistrationId" uuid`);
        await queryRunner.query(`
    ...
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "core"."application" DROP CONSTRAINT "FK_ca635da088fa8d5379ed268b55e"`);
        await queryRunner.query(`ALTER TABLE "core"."application" DROP COLUMN "applicationRegistrationId"`);
        await queryRunner.query(`ALTER TABLE "core"."applicationRegistrationVariable" DROP CONSTRAINT "FK_067a6267789011853178a6ab57a"`);
        await queryRunner.query(`ALTER TABLE "core"."applicationRegistrationVariable" DROP CONSTRAINT "IDX_APP_REG_VAR_KEY_APP_REGISTRATION_ID_UNIQUE"`);
        await queryRunner.query(`DROP INDEX "core"."IDX_APP_REG_VAR_APP_REGISTRATION_ID"`);
        await queryRunner.query(`DROP TABLE "core"."applicationRegistrationVariable"`);
        await queryRunner.query(`ALTER TABLE "core"."applicationRegistration" DROP CONSTRAINT "FK_d5aa70ce34f5b8e51e5b0deafc2"`);
        await queryRunner.query(`DROP INDEX "core"."IDX_APPLICATION_REGISTRATION_CREATED_BY_USER_ID"`);
        await queryRunner.query(`DROP INDEX "core"."IDX_APPLICATION_REGISTRATION_OAUTH_CLIENT_ID_UNIQUE"`);
        await queryRunner.query(`DROP INDEX "core"."IDX_APPLICATION_REGISTRATION_UNIVERSAL_IDENTIFIER_UNIQUE"`);
        await queryRunner.query(`DROP TABLE "core"."applicationRegistration"`);
    }
    constructor(){
        this.name = 'CreateApplicationRegistration1772267875868';
    }
};

//# sourceMappingURL=1772267875868-create-application-registration.js.map