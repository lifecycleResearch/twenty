...
const _getpreviousversion = require("../get-previous-version");
describe('It should return the previous version from a list of', ()=>{
    ...
    test.each(testCase)(' $title', ({ context: { versions, currentVersion, expected } })=>{
        const result = (0, _getpreviousversion.getPreviousVersion)({
            versions,
            currentVersion
        });
...
//# sourceMappingURL=get-previous-version.spec.js.map