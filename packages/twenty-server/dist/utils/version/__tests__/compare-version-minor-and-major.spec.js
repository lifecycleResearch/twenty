...
const _compareversionminorandmajor = require("../compare-version-minor-and-major");
describe('It should compare two versions with', ()=>{
    const beneathVersionTestCases = [
        {
            context: {
                version1: '1.0.0',
                version2: '1.1.0',
    ...
    ])(' $title', ({ context: { version1, version2, expected, expectToThrow = false } })=>{
        if (expectToThrow) {
            expect(()=>(0, _compareversionminorandmajor.compareVersionMajorAndMinor)(version1, version2)).toThrowErrorMatchingSnapshot();
        } else {
            expect((0, _compareversionminorandmajor.compareVersionMajorAndMinor)(version1, version2)).toBe(expected);
        }
    });
});

//# sourceMappingURL=compare-version-minor-and-major.spec.js.map