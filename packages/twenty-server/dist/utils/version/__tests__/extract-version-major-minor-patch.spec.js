...
const _extractversionmajorminorpatch = require("../extract-version-major-minor-patch");
describe('It should extract major.minor.patch values from a', ()=>{
    ...
    test.each(testCase)(' $title', ({ context: { version, expected } })=>{
        expect((0, _extractversionmajorminorpatch.extractVersionMajorMinorPatch)(version)).toBe(expected);
    });
});

//# sourceMappingURL=extract-version-major-minor-patch.spec.js.map